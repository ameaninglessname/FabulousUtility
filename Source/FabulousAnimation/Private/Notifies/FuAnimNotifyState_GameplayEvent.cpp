...
{
	TStringBuilder<192> NotifyNameBuilder{InPlace, ANSITEXTVIEW("Fu Gameplay Event: ")};
...
#endif
	{
		NotifyNameBuilder << BeginEventTag.GetTagName() << ANSITEXTVIEW(" - ") << EndEventTag.GetTagName();
	}
